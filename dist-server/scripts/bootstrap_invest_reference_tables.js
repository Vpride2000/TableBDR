...
async function bootstrapTable(client, definition) {
    await client.query(`
  ...
  `);
    const result = await client.query(`SELECT COUNT(*)::text AS count FROM "${definition.tableName}"`);
...
main();
//# sourceMappingURL=bootstrap_invest_reference_tables.js.map