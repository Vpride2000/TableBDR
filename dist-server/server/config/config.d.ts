...
export declare const INVEST_REFERENCE_TABLES: ReferenceTableDefinition[];
export declare const CONTRACT_ADDITIONAL_AGREEMENTS_SEEDS: ContractAdditionalAgreementSeed[];
export declare const CONTRACT_ROW_SEEDS: ContractRowSeed[];
export declare const INVEST_PROGRAM_SEEDS: InvestProgramRowSeed[];
