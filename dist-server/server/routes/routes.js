...
import { GN_TABLE_CONFIGS, BDR_SELECT_FIELDS } from '../config/config.js';
...
export function setupRoutes(app) {
    ...
    app.post('/api/gn/bdr', async (req, res) => {
        const { pao_budget_item, department, object_name, dogovor, contractor, budget_item, predmet_dogovora, ed_izm, kol_vo, limit, edin_limit, comments, } = req.body;
        if (!pao_budget_item ||
            !department ||
            !object_name ||
            !dogovor ||
